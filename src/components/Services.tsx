...
const toolLogos = [
  { name: "n8n", svg: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12.76 1.64C14.346.054 16.893.054 18.48 1.64l3.878 3.879c1.586 1.586 1.586 4.133 0 5.72l-3.879 3.878c-1.586 1.586-4.133 1.586-5.72 0L8.883 11.24c-1.586-1.586-1.586-4.133 0-5.72zm-1.52 8.96l3.878 3.878c1.586 1.586 1.586 4.134 0 5.72l-3.879 3.879c-1.586 1.586-4.133 1.586-5.72 0L1.643 20.2c-1.586-1.587-1.586-4.134 0-5.72L5.52 10.6c1.586-1.586 4.133-1.586 5.72 0z"/></svg>' },
  { name: "Make", svg: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.568 14.784c-.576 1.152-1.536 1.92-2.784 2.304-1.248.384-2.496.192-3.648-.384L7.2 18.72c-.192.096-.384.096-.576 0l-1.536-.768c-.192-.096-.288-.288-.288-.48V6.528c0-.192.096-.384.288-.48l1.536-.768c.192-.096.384-.096.576 0l3.936 2.016c1.152-.576 2.4-.768 3.648-.384 1.248.384 2.208 1.152 2.784 2.304.576 1.152.576 2.4 0 3.568z"/></svg>' },
  { name: "Zapier", svg: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M15.477 4.986l-3.014 3.014h-4.97L4.48 4.986l3.014-3.014h4.97l3.014 3.014zm4.538 4.537l-3.014 3.014v4.97l3.014 3.014 3.014-3.014v-4.97l-3.014-3.014zM4.986 8.523L1.972 11.537v4.97l3.014 3.014 3.014-3.014v-4.97L4.986 8.523zm10.49 10.49l-3.013 3.015h-4.97L4.48 19.014l3.014-3.014h4.97l3.014 3.014z"/></svg>' },
  { name: "Google Calendar", svg: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M18.316 5.684H24v12.632h-5.684V5.684zM5.684 24h12.632v-5.684H5.684V24zM18.316 5.684V0H5.684v5.684h12.632zM5.684 18.316H0V5.684h5.684v12.632zM7.953 14.18l1.21-.933c.387.414.788.699 1.315.699.456 0 .748-.227.748-.559 0-.387-.3-.559-.808-.8l-.452-.195c-.828-.352-1.377-.794-1.377-1.728 0-.86.656-1.515 1.681-1.515.73 0 1.255.254 1.632.92l-1.178.907c-.23-.414-.48-.577-.798-.577-.363 0-.593.23-.593.577 0 .402.23.564.762.812l.452.195c.975.418 1.524.845 1.524 1.803 0 1.034-.812 1.6-1.903 1.6-1.066 0-1.756-.508-2.215-1.205zm5.873-.195V9.72h-1.15l.195-1.394h2.79v5.66h-1.835z"/></svg>' },
  ...
  { name: "Twilio", svg: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.381 0 0 5.381 0 12s5.381 12 12 12 12-5.381 12-12S18.619 0 12 0zm0 20.006c-4.418 0-8.006-3.588-8.006-8.006S7.582 3.994 12 3.994s8.006 3.588 8.006 8.006-3.588 8.006-8.006 8.006zm3.08-11.085a2.003 2.003 0 1 1-2.833-2.833 2.003 2.003 0 0 1 2.833 2.833zm0 5.912a2.003 2.003 0 1 1-2.833-2.833 2.003 2.003 0 0 1 2.833 2.833zm-5.912 0a2.003 2.003 0 1 1-2.833-2.833 2.003 2.003 0 0 1 2.833 2.833zm0-5.912a2.003 2.003 0 1 1-2.833-2.833 2.003 2.003 0 0 1 2.833 2.833z"/></svg>' },
  ...
  { name: "Gmail", svg: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 0 1 0 19.366V5.457c0-2.023 2.309-3.178 3.927-1.964L5.455 4.64 12 9.548l6.545-4.91 1.528-1.145C21.69 2.28 24 3.434 24 5.457z"/></svg>' },
];
