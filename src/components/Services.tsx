...
const toolLogos = [
  { name: "ClickUp", color: "#7B68EE", svg: '<svg viewBox="0 0 24 24"><path d="M12 2L2 8.5v7L12 22l10-6.5v-7L12 2zm0 2.5l6.5 4-6.5 4-6.5-4 6.5-4zm-7 6l7 4.3 7-4.3v5.8l-7 4.5-7-4.5v-5.8z"/></svg>' },
