          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <nav className="flex flex-col gap-2">
                ...
                <button onClick={onContactClick} className="text-sm text-muted-foreground hover:text-primary transition-colors text-left">
                  Contact
                </button>
              </nav>
            </div>
              ...
              <div className="flex gap-3">
                {social.map((item) => (
                  <a
                    ...
                    className="p-2.5 rounded-xl border border-border/30 hover:border-primary/30 text-muted-foreground hover:text-primary transition-all duration-300"
