        ...
        <div ref={ref} className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              {/* Video */}
              <div className="mt-8 rounded-2xl border border-border/30 bg-card/30 overflow-hidden">
            ...
            >
              <div className="rounded-2xl border border-border/30 bg-card/30 p-8 sm:p-10">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-semibold text-foreground">Empower Estates Network</p>
                    <p className="text-sm text-muted-foreground">Real Estate Technology</p>
                  </div>
                </div>
              </div>

              {/* Additional mini testimonial */}
              <div className="mt-4 rounded-2xl border border-border/30 bg-card/30 p-6">
